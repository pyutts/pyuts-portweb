...
export default function Projects({ onProjectSelect }: ProjectsProps) {
  return (
    <section id="projects" className="py-20 backdrop-blur-md relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">
            My <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-500">Projects</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
           <div
              key={index}
              className="cursor-pointer bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 group transform transition-all duration-500 hover:-translate-y-2"
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black 700/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
